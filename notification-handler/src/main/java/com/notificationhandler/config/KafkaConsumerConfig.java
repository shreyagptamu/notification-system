...
public class KafkaConsumerConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, MessageDTO> fooKafkaListenerContainerFactory() {
        return kafkaListenerContainerFactory("notificationGroup");
    }
}
